workspace {
    ...
    model {
        ...
        healthcareProvidersPortal = softwareSystem "Healthcare Providers Portal" {
            description "Application where healthcare providers manage their work"
        }
        patientsPortal = softwareSystem "Patients Portal" {
            description "Portal for patients to manage their healthcare (work with HIPAA-related data)."
        }
        insuranceService = softwareSystem "Insurance Service" {
            description "Manages insurance-related data (may include PHI)"
        }
        ...
        healthcareProvidersPortal -> auditAsAServiceSolution "Logs provider activities and data access"
        patientsPortal -> auditAsAServiceSolution "Logs patient activities and data access"
        insuranceService -> auditAsAServiceSolution "Logs insurance-related activities"
    ...
    views {
        systemContext auditAsAServiceSolution {
            ...
            include healthcareProvidersPortal
            include patientsPortal
            include insuranceService
