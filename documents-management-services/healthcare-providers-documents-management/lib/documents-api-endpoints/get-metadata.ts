...
const resourcesNames = {
    ...
    iamRole: AWS_RESOURCES_NAMING_CONVENTION.replace('$', 'get-metadata-role'),
    iamPolicy: AWS_RESOURCES_NAMING_CONVENTION.replace('$', 'get-metadata-policy'),
    apiEndpoint: 'get-metadata',
    apiRequestModel: `${AWS_REQUETS_MODELS_NAMING_CONVENTION}GetMetadata`
};
export default function getDocumentMetadataAction(
    scope: Construct, 
